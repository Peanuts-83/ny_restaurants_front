...
import { AppHttpResponse } from "../models/app-http-response.interface"
...
export class InfiniteScrollService extends BaseApiService {
  ...
  public loadNext<T>(a_config: InputConf, a_items: T[]): Observable<T[]> {
    if (a_items.length < a_config.params.nbr! * a_config.params.page_nbr!) {
      // TODO: should return end of list
      return of([])
    }
    a_config.params.page_nbr! += 1
